---
description: Add comprehensive unit tests for the specified Python source code file. Example: `/add-test-for-module /path/to/{{ cookiecutter.package_name }}/math_ops.py comprehensive "optional additional requirements"`
allowed-tools: Write({{ cookiecutter.package_name }}/**/*.py), Write(tests/**/*.py), Bash(.venv/bin/python tests/**/*.py)
---
